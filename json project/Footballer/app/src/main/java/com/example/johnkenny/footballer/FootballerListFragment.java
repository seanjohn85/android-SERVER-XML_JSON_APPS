...
import com.example.johnkenny.footballer.httpAndParser.FootballerJSONPhaser;
...
public class FootballerListFragment extends ListFragment {
    ...
    private class MyTask extends AsyncTask<String, String, List<Footballer>> {
        ...
        String players;
        FootballerJSONPhaser parser = new FootballerJSONPhaser();
        ...
        protected List <Footballer> doInBackground(String... params) {
            ...
            String contents = manager.getData("http://10.0.2.2/android/footballers.json");
